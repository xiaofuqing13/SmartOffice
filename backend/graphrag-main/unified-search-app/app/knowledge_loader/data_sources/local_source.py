...
class LocalDatasource(Datasource):
    ...
    def write(
        ...
        table_path = os.path.join(self._base_path, f"{table}.parquet")  # noqa: PTH118
        
        if mode == WriteMode.Append and os.path.exists(table_path):  # noqa: PTH110
    ...
    def has_table(self, table: str) -> bool:
        """Check if table exists method implementation."""
        table_path = os.path.join(self._base_path, f"{table}.parquet")  # noqa: PTH118
        return os.path.exists(table_path)  # noqa: PTH110
